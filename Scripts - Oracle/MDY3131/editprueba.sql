...
BEGIN
    ...
    LOOP
            ...
            FOR cur_diario IN (
                ...
                EXCEPTION
                    WHEN TOO_MANY_ROWS THEN
                        ...
                        v_errtext, 'Se encontro mas de un porcentaje de gravamen para el monto de los pedidos del dia: ' || v_dia);
                    ...
                    WHEN NO_DATA_FOUND THEN
                        ...
                        v_errtext := SQLERRM;
                        INSERT INTO errores_proceso_recaudacion VALUES(sq_error.nextval, 
                        v_errtext, 'No se econtro porcentaje de gravamen para el monto de los pedidos del dia: ' || v_dia);
        ...
        END LOOP;
        dbms_output.put_line(r2.cepa || ' ' || r2.num_pedidos || ' ' || r2.monto_pedidos || ' ' || r2.gravamenes);
